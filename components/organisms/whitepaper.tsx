...
const WhitePaper = () => (
  <div className="mt-24 relative bg-white pt-16 pb-32 overflow-hidden">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <p className="mt-4 text-lg text-gray-500">
                &quot;If one co-invests in Green Co-investment Instruments
                (GCIs) in proportion to the size and duration of one’s bitcoin
                holdings, one’s bitcoin and green mining investments together
                will produce no net incentive to mine bitcoin in a
